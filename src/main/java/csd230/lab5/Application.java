...
import csd230.lab5.repositories.BookRepository;
import csd230.lab5.repositories.CartItemRepository;
import csd230.lab5.repositories.CartRepository;
	...
	public CommandLineRunner demo(BookRepository repository) {
		return (args) -> {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                csd230.lab5.entities.Book book = new csd230.lab5.entities.Book(
                        price,
                        quantity,
                        description,
                        title,
            ...
            csd230.lab5.entities.Book book = repository.findById(1L);
